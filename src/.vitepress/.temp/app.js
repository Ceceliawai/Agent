...
import { u as useData$1, i as isExternal, t as treatAsHtml, w as withBase, a as isActive, g as getScrollOffset, o as onContentUpdated, E as EXTERNAL_URL_RE, b as useRoute, c as inBrowser, d as createTitle, m as mergeHead, p as pathToFile, R as RouterSymbol, e as initData, f as dataSymbol, C as Content, s as siteDataRef, h as createRouter } from "./Content.Btcud0f7.js";
...
const _sfc_main$u = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.CLqwjKyq.js"));
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function formatCount(count) {
      return count >= 1e3 ? `${(count / 1e3).toFixed(1)}k` : count.toString();
    }
    onMounted(async () => {
      try {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<span>Star</span>`);
      if (starCount.value !== null) {
        _push(`<span class="github-star__count">${ssrInterpolate(formatCount(starCount.value))}</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</a>`);
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../src/.vitepress/theme/components/GitHubStar.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../src/.vitepress/theme/Layout.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const RawTheme = {
  extends: theme,
